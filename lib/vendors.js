module.exports = {
	bitdo_Dinput: {
		...
		update: function (data) {
			...
			state["button:A"] = data[8] & 1;
			state["button:B"] = (data[8] >> 1) & 1;
			state["button:X"] = (data[8] >> 3) & 1;
			state["button:Y"] = (data[8] >> 4) & 1;

			state["button:L1"] = (data[8] >> 6) & 1;
			state["button:R1"] = (data[8] >> 7) & 1;
			state["button:L2"] = data[9] & 1;
			state["button:R2"] = (data[9] >> 1) & 1;
			...
			state["button:Up"] = data[1] === 0 ? 1 : 0;
			state["button:Right"] = data[1] === 2 ? 1 : 0;
			state["button:Down"] = data[1] === 4 ? 1 : 0;
			state["button:Left"] = data[1] === 6 ? 1 : 0;

			state["button:Start"] = (data[9] >> 3) & 1;
			state["button:Select"] = (data[9] >> 2) & 1;
